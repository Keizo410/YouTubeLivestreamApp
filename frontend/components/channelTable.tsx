...
export default function ChannelTableComponent({ data }: tableTypeProps) {
  ...
  return (
    <SafeAreaView style={styles.tableColumns}>
      <View style={styles.nameColumn}>
        <Text style={styles.headText}>Channels</Text>
        <Rows
          data={data.tableData.map((row: any[]) => [row[0]])}
          textStyle={styles.dataText}
        />
      </View>
      <View style={styles.youtuberColumn}>
        <Text style={styles.headText}>Youtubers</Text>
        <Rows
